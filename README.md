...
| ![Preview of graphics mode for "kirby_and_the_forgotten_land.bin"](custom/kirby_and_the_forgotten_land_graphics.png?raw=true "kirby_and_the_forgotten_land.bin (Graphics Mode)") [View text mode](custom/kirby_and_the_forgotten_land_text.png?raw=true) | [kirby_and_the_forgotten_land.bin](custom/kirby_and_the_forgotten_land.bin?raw=true) | The in-game font extracted from Kirby and the Forgotten Land. Includes letters (uppercase only), numbers, and symbols. | [Patrick Mollohan](https://github.com/patrickmollohan) |
